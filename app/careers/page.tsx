                ...
                {benefits.map((benefit, index) => {
                  ...
                  return (
                    <Card key={index} className="p-6 text-center hover:shadow-lg transition-shadow">
                      <div className="w-14 h-14 bg-[#f29200]/10 rounded-xl flex items-center justify-center mx-auto mb-4">
                        <Icon className="w-7 h-7 text-[#f29200]" />
                      </div>
                    ...
                    <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
                      <div className="flex-1">
                        <div className="flex flex-wrap items-center gap-3 mb-3">
                          <span className="inline-block px-3 py-1 bg-[#f29200]/10 text-[#f29200] rounded-full text-xs font-semibold">
                            {job.department}
                          </span>
                      ...
                      <div className="md:ml-4">
                        <Link href={`/contact?job=${job.id}`}>
                          <Button className="bg-[#f29200] hover:bg-[#d17e00] text-white whitespace-nowrap">
                            Postuler
        ...
        <section className="py-20 bg-white">
          <div className="container mx-auto px-4 lg:px-8">
            <div className="max-w-3xl mx-auto text-center bg-gradient-to-br from-[#f29200] to-[#d17e00] rounded-2xl p-12 text-white">
              ...
              <Link href="/contact">
                <Button size="lg" className="bg-white text-[#f29200] hover:bg-gray-100">
