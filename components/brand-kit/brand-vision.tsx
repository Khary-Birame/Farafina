      ...
      <div className="container mx-auto max-w-5xl">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {keywords.map((item, index) => (
            <div
              key={index}
              className="flex flex-col items-center gap-4 p-6 bg-white rounded-2xl border-2 border-[#E5E5E5] hover:border-[#008037] transition-all hover:shadow-lg group"
            >
              <div className="w-16 h-16 bg-gradient-to-br from-[#008037] to-[#00a045] rounded-2xl flex items-center justify-center group-hover:scale-110 transition-transform">
