      ...
      <div className="container mx-auto max-w-6xl">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="text-center">
            <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-8 mb-6 border border-white/20 hover:border-[#f29200] transition-colors">
              <Monitor className="w-20 h-20 text-[#D4AF37] mx-auto mb-4" />
              <div className="bg-gradient-to-br from-[#f29200] to-[#00a045] h-32 rounded-xl mb-4" />
            </div>
          ...
          <div className="text-center">
            <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-8 mb-6 border border-white/20 hover:border-[#f29200] transition-colors">
              ...
              <div className="bg-gradient-to-br from-[#f29200] to-[#00a045] h-32 rounded-xl mb-4 max-w-[200px] mx-auto" />
            </div>
          ...
          <div className="text-center">
            <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-8 mb-6 border border-white/20 hover:border-[#f29200] transition-colors">
              ...
              <div className="bg-gradient-to-br from-[#f29200] to-[#00a045] h-32 rounded-xl mb-4 max-w-[120px] mx-auto" />
            </div>
