        ...
        <div className="mb-16">
          ...
          <div className="bg-white p-12 rounded-3xl border border-[#E5E5E5] shadow-lg">
            <div className="flex flex-wrap gap-6 items-center">
              <Button className="bg-[#16A34A] hover:bg-[#15803D] text-white">Bouton Principal</Button>
              <Button className="bg-[#D4AF37] hover:bg-[#b8962e] text-[#2E2E2E]">Bouton Or</Button>
              <Button
                variant="outline"
                className="border-[#16A34A] text-[#16A34A] hover:bg-[#16A34A] hover:text-white bg-transparent"
              >
                Bouton Contour
              </Button>
          ...
          <div className="bg-white p-12 rounded-3xl border border-[#E5E5E5] shadow-lg">
            <div className="grid md:grid-cols-2 gap-6 max-w-3xl">
              <div>
                ...
                <Input placeholder="Entrez votre nom" className="border-[#E5E5E5] focus:border-[#16A34A]" />
              </div>
              <div>
                <label className="block text-sm font-mono font-medium text-[#2E2E2E] mb-2">Saisie Email</label>
                <Input type="email" placeholder="votre@email.com" className="border-[#E5E5E5] focus:border-[#16A34A]" />
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mb-16">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <Card className="p-6 bg-white border-[#E5E5E5] hover:shadow-xl transition-shadow">
              <div className="w-12 h-12 bg-[#16A34A] rounded-xl flex items-center justify-center mb-4">
            ...
            <Card className="p-6 bg-gradient-to-br from-[#16A34A] to-[#22C55E] text-white hover:shadow-xl transition-shadow">
