export function CoverSlide() {
  return (
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden">
      {/* Background Gradient */}
      <div className="absolute inset-0 bg-gradient-to-br from-[#f29200] via-[#00a045] to-[#D4AF37] opacity-90" />
      ...
      <div className="relative z-10 text-center px-4 max-w-5xl mx-auto">
        ...
        <div className="mb-8 flex justify-center">
          <div className="w-32 h-32 bg-white rounded-3xl flex items-center justify-center shadow-2xl">
            <span className="text-[#f29200] font-sans font-bold text-5xl">FFA</span>
          </div>
        </div>
