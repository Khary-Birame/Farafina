  ...
  return (
    <section className="py-20 lg:py-28 bg-gradient-to-br from-[#1a1a1a] via-[#2E2E2E] to-[#1a1a1a] relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-5">
        <div className="absolute top-1/4 left-10 w-96 h-96 bg-[#f29200] rounded-full blur-3xl" />
        <div className="absolute bottom-1/4 right-10 w-96 h-96 bg-[#D4AF37] rounded-full blur-3xl" />
      </div>

      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 bg-gradient-to-r from-[#f29200]/20 to-[#D4AF37]/20 px-4 py-2 rounded-full mb-4 border border-[#f29200]/30">
            <CheckCircle className="w-4 h-4 text-[#f29200]" />
            <span className="text-sm font-medium text-[#f29200]">Parcours de Candidature</span>
          </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 max-w-7xl mx-auto">
          {steps.map((step, index) => (
            <div
              key={index}
              className="group relative bg-gradient-to-br from-white/5 to-white/0 backdrop-blur-sm border border-white/10 rounded-2xl p-6 hover:border-[#f29200] hover:shadow-2xl hover:shadow-[#f29200]/20 transition-all duration-500 hover:-translate-y-2"
            >
              {/* Gradient Accent */}
              ...
              <div className="text-center">
                <h3 className="text-lg font-bold text-white mb-3 group-hover:text-[#f29200] transition-colors duration-300">
                  {step.title}
                </h3>
              ...
              {/* Hover Glow Effect */}
              <div className="absolute inset-0 rounded-2xl bg-gradient-to-br from-[#f29200]/10 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-500 pointer-events-none" />
            </div>
          ))}
        </div>
        ...
        <div className="mt-16 text-center">
          <div className="inline-block bg-gradient-to-r from-[#f29200]/20 to-[#D4AF37]/20 backdrop-blur-sm border border-[#f29200]/30 rounded-2xl p-6 max-w-2xl">
