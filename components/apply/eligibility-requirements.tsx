...
export function EligibilityRequirements() {
  const eligibilityCriteria = [
    ...
    "Ouvert à tous les genres et nationalités",
  ]
    ...
    <section className="py-20 lg:py-24 bg-white">
      <div className="container mx-auto px-4 lg:px-8">
        <div className="text-center mb-12">
          <h2 className="text-3xl lg:text-4xl font-sans font-bold text-[#2E2E2E] mb-4">Éligibilité et Exigences</h2>
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          <div>
            <h3 className="text-2xl font-sans font-bold text-[#2E2E2E] mb-6">Qui Peut Postuler</h3>
          ...
          <div>
            <h3 className="text-2xl font-sans font-bold text-[#2E2E2E] mb-6">Documents Requis</h3>
            <p className="text-muted-foreground mb-6 leading-relaxed">
