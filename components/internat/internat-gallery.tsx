...
export function InternatGallery() {
  ...
  const galleryItems = [
    {
      ...
      title: t("internat.gallery.item1", "Chambres Modernes"),
    },
    {
      type: "image" as const,
      src: "/african-students-studying-in-modern-classroom.jpg",
      title: t("internat.gallery.item2", "Salles d'Étude"),
    },
    {
      type: "image" as const,
      src: "/african-football-academy-elite-training.jpg",
      title: t("internat.gallery.item3", "Installations Sportives"),
    },
    {
      type: "image" as const,
      src: "/african-youth-football-training-action-shot.jpg",
      title: t("internat.gallery.item4", "Vie à l'Internat"),
    },
    {
      type: "image" as const,
      src: "/young-african-football-players-training.jpg",
      title: t("internat.gallery.item5", "Espaces Communs"),
    },
    {
      type: "video" as const,
      src: "/student-residence-dormitory.jpg",
      title: t("internat.gallery.item6", "Vidéo de Présentation"),
    },
  ]
      ...
      <div className="container mx-auto px-4 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-16">
          <div className="inline-flex items-center gap-2 rounded-full border border-[#D4AF37]/30 bg-[#D4AF37]/10 px-4 py-1.5 text-sm text-[#D4AF37] mb-6">
            ...
            {t("internat.gallery.badge", "Galerie")}
          </div>
          <h2 className="font-sans font-black text-4xl md:text-5xl lg:text-6xl text-gray-900 mb-6 text-balance">
            <span className="bg-gradient-to-r from-gray-900 via-[#D4AF37] to-gray-900 bg-clip-text text-transparent">
              {t("internat.gallery.title", "Galerie Photos & Vidéos")}
            </span>
          </h2>
          <p className="text-xl text-gray-700 max-w-3xl mx-auto leading-relaxed">
            {t("internat.gallery.description", "Découvrez en images la vie quotidienne à l'internat de Farafina Foot Academy.")}
          </p>
        </div>
