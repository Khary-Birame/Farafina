          ...
          <div>
            ...
            <div className="space-y-4 mb-8">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="font-semibold text-[#2E2E2E] mb-1">Sessions Techniques et Tactiques Quotidiennes</h4>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="font-semibold text-[#2E2E2E] mb-1">Préparation Physique et Mentale</h4>
                  <p className="text-sm text-muted-foreground">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="font-semibold text-[#2E2E2E] mb-1">Analyse Vidéo et Performance</h4>
                  <p className="text-sm text-muted-foreground">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <h4 className="font-semibold text-[#2E2E2E] mb-1">Compétitions Officielles</h4>
                  <p className="text-sm text-muted-foreground">
