        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 bg-[#D4AF37]/10 px-4 py-2 rounded-full mb-4">
              ...
              <span className="text-sm font-semibold text-[#D4AF37]">Inclusion sociale et opportunités</span>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            {scholarshipTypes.map((scholarship, index) => {
              ...
              return (
                <div
                  key={index}
                  className="bg-card border border-border rounded-xl p-6 hover:shadow-xl hover:border-[#D4AF37] hover:-translate-y-2 transition-all duration-300 group"
                >
                  <div className="w-14 h-14 bg-gradient-to-br from-[#D4AF37]/10 to-[#D4AF37]/5 rounded-xl flex items-center justify-center mb-4 group-hover:scale-110 group-hover:bg-gradient-to-br group-hover:from-[#D4AF37] group-hover:to-[#d17e00] transition-transform duration-300">
                    <Icon className="w-7 h-7 text-[#D4AF37] group-hover:text-white transition-colors duration-300" />
                  </div>
                  <h3 className="font-sans font-semibold text-lg mb-2 group-hover:text-[#D4AF37] transition-colors duration-300">{scholarship.title}</h3>
          ...
          {/* Values Statement */}
          <div className="bg-gradient-to-br from-[#D4AF37] to-[#d17e00] text-white rounded-xl p-8 md:p-12">
