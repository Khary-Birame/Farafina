          ...
          <div className="bg-white/95 backdrop-blur-md rounded-3xl p-8 lg:p-12 shadow-2xl border-2 border-white/50">
            <div className="text-center">
              ...
              <p className="text-lg md:text-xl text-gray-700 mb-8 leading-relaxed max-w-2xl mx-auto">
                {t("news.cta.description", "Abonnez-vous à notre newsletter pour recevoir les dernières actualités et événements directement dans votre boîte de réception.")}
              </p>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link href="/contact">
                  ...
                  >
                    ...
                    {t("news.cta.subscribeButton", "S'abonner à la Newsletter")}
                  </Button>
                </Link>
                <Link href="/events">
                  <Button
                  ...
                  >
                    {t("news.cta.eventsButton", "Voir les Événements")}
